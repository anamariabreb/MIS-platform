...
define('SECRET_SALT','MVP45syTNaKjiUImwwP8br6pP3DZEv3s');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','anamariabreb@gmail.com');
...
define('DBNAME','Comp6-osTicket');
define('DBUSER','anamaria');
define('DBPASS','testing123');
